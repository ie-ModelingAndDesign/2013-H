...
- (void)viewDidLoad
{
    ...
    if (save7 == nil) {
        ...
        comment.text = [NSString stringWithFormat:@"今日の体重入力がまだみたい！"];
    }
    ...
    CPTMutableLineStyle *graphlineStyle2 = [scatterPlot2.dataLineStyle mutableCopy];
    graphlineStyle2.lineWidth = 3;// 太さ
    graphlineStyle2.lineColor = [CPTColor colorWithComponentRed:0.0f green:0.0f blue:1.0f alpha:1.0f];// 色
    scatterPlot2.dataLineStyle = graphlineStyle2;
